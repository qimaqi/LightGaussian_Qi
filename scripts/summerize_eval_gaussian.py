...
if __name__ == "__main__":
	...
	for obj_i in shapenet_v1_dict:
		...
		mmt_results.append(float(shapenet_v1_dict[obj_i]['mmd_xy']))
		mmt_results.append(float(shapenet_v1_dict[obj_i]['mmd_yz']))
		...
		jsd_results.append(float(shapenet_v1_dict[obj_i]['jsd_xy']))
		jsd_results.append(float(shapenet_v1_dict[obj_i]['jsd_yz']))
