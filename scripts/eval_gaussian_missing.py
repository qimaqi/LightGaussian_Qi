...
if __name__ == "__main__":
	...
	shapenet_v1_dict_gs = {}
	missing_name = ['8f39d2dbb98bce6057b643a522b3d830', '1435b52348569ce1bd46d022fd7d80aa','50c446295496eca73542594e05cedc89', '67bee18dec77f305e4af5827e8177766']
	...
	for obj_path in tqdm(obj_total_path):
		...
		if os.path.exists(pointcloud_gs): #and os.path.exists(num_align_gs):
			...
			print("obj_i_metric_dict", obj_i_metric_dict)
